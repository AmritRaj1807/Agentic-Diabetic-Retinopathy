...
class Config:
   ...
   # Folder containing input images
    input_dir: Path = Path(
    r"D:\Projects\Diabetic Retinopathy\Diabetic-Retinopathy-Grading\dataset\deepdrdoc-DeepDRiD-56d8af7\regular_fundus_images\regular-fundus-validation\Images"
)

    # Output folder
    output_dir: Path = Path(
    r"D:\Projects\Diabetic Retinopathy\Diabetic-Retinopathy-Grading\dataset\processed_validation"
)

    # CSV
    csv_path: Path | None = Path(
    r"D:\Projects\Diabetic Retinopathy\Diabetic-Retinopathy-Grading\dataset\deepdrid_validation_labels.csv"
)
