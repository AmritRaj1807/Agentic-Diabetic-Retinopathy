...
class Config:
    ...
    data_dir: Path = Path(
    r"D:\Projects\Diabetic Retinopathy\Diabetic-Retinopathy-Grading\dataset\processed_training"
)

    csv_path: Path = Path(
    r"D:\Projects\Diabetic Retinopathy\Diabetic-Retinopathy-Grading\dataset\deepdrid_train_labels.csv"
)
    image_col: str = "image"
    label_col: str = "level"
    num_classes: int = 5
